            ...
            <div class="col-lg-6 col-md-8 col-12 mt-2">
                <div class="card my-3 bg-dark rounded-1 border-0 shadow">
                    <div class="card-body mx-2">
                        <form action="/app/nominals" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mt-3">
                            ...
                            <div class="mt-3">
                                ...
                                <select name="games_id" id="" class="form-control dark @error('games_id') is-invalid @enderror bg-soft-dark border-0 text-white fs-sm rounded-1">
                                    ...
                                    @foreach ($games as $data)
                                        <option {{ $data->id == old('games_id') ? 'selected' : '' }} value="{{$data->id}}">{{$data->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mt-3">
                                ...
                                <input autocomplete="off" type="number" name="price" required value="{{old('price')}}" class="form-control dark @error('price') is-invalid @enderror bg-soft-dark border-0 text-white fs-sm rounded-1">
